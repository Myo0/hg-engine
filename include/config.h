...
// // Uncomment to enable Retaliate flag debug prints (no$gba/mgba console)
// #define DEBUG_RETALIATE
...
// UNSEEN_FIST_GENERATION defines the behavior that Unseen Fist should exhibit, where it either completely ignores Protect (<=8) or deals reduced (Electrum: 0.5x) Damage through Protect (>=9)
