...
#define SUB_SEQ_REMOVE_ATTACKER_ITEM                  (MAX_BASE_SUBSCRIPT_NUM + 1) //Used for gems, thx dray //was 375
#define SUB_SEQ_STRENGTH_SAP                          (MAX_BASE_SUBSCRIPT_NUM + 2) //for strength sap, thx dray
#define SUB_SEQ_ATK_AND_SPATK_DOWN                    (MAX_BASE_SUBSCRIPT_NUM + 3) //for noble roar and tearful look
#define SUB_SEQ_PARTING_SHOT                          (MAX_BASE_SUBSCRIPT_NUM + 4) //parting shot 
#define SUB_SEQ_ELECTRO_SHOT_RAIN                     (MAX_BASE_SUBSCRIPT_NUM + 5) //for the no powerherb needed in rain 
