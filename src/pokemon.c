...
BOOL LONG_CALL ScrNative_WaitApplication(struct SCRIPTCONTEXT *ctx);
...
#define sp54 stack_data[0]
    ...
    struct ItemData *itemData = LoadItemDataOrGfx(itemID, ITEM_GET_DATA, heapID);
    if (itemData->partyUse != 1) {
    ...
    if (itemData->partyUseParam.slp_heal) {
        sp58 &= ~STATUS_SLEEP;  //worried about changing these after battle engine upgrade
        effectFound = TRUE;
    }
    ...
    if ((GetItemAttr_PreloadedItemData(itemData, ITEM_PARAM_DEATH_RECOVERY) || GetItemAttr_PreloadedItemData(itemData, ITEM_PARAM_ALL_DEATH_RECOVERY)) 
        && GetItemAttr_PreloadedItemData(itemData, ITEM_PARAM_LEVEL_UP)) {
        if (sp54 == 0) {
...
const u8 sTrainerGenders[] = {
    [TRAINERCLASS_JASPER] = TRAINER_MALE,
    [TRAINERCLASS_AMETHYST] = TRAINER_FEMALE,
    ...
    [TRAINERCLASS_PLASMA_M] = TRAINER_MALE,
    [TRAINERCLASS_PLASMA_F] = TRAINER_FEMALE,
    [TRAINERCLASS_SAILOR] = TRAINER_MALE,
    [TRAINERCLASS_TRAINER_N] = TRAINER_FEMALE,
    [TRAINERCLASS_RUIN_MANIAC] = TRAINER_MALE,
    [TRAINERCLASS_PSYCHIC_M] = TRAINER_MALE,
    [TRAINERCLASS_PSYCHIC_F] = TRAINER_FEMALE,
    [TRAINERCLASS_SAGE_ROOD] = TRAINER_MALE,
    ...
    [TRAINERCLASS_SAGE_GIALLO] = TRAINER_FEMALE,
    ...
    [TRAINERCLASS_COLRESS] = TRAINER_FEMALE,
    [TRAINERCLASS_STEVEN] = TRAINER_MALE,
    ...
    [TRAINERCLASS_DARKRAI] = TRAINER_MALE,
    [TRAINERCLASS_LEADER_BROCK] = TRAINER_MALE,
    [TRAINERCLASS_ZINZOLIN] = TRAINER_FEMALE,
    [TRAINERCLASS_GHETSIS] = TRAINER_MALE,
    [TRAINERCLASS_GARDENIA] = TRAINER_FEMALE,
    [TRAINERCLASS_ROXIE] = TRAINER_MALE,
    [TRAINERCLASS_MISTY] = TRAINER_FEMALE,
    [TRAINERCLASS_LT_SURGE] = TRAINER_MALE,
    [TRAINERCLASS_ERIKA] = TRAINER_FEMALE,
    [TRAINERCLASS_DUSKNOIR] = TRAINER_FEMALE,
    [TRAINERCLASS_CYNTHIA_OPPONENT] = TRAINER_FEMALE,
    [TRAINERCLASS_HANNAH] = TRAINER_MALE,
    ...
    [TRAINERCLASS_JUPITER] = TRAINER_FEMALE,
    [TRAINERCLASS_BOARDER] = TRAINER_MALE,
    [TRAINERCLASS_CYRUS] = TRAINER_MALE,
    [TRAINERCLASS_SATURN] = TRAINER_MALE,
    [TRAINERCLASS_MARS] = TRAINER_MALE,
    [TRAINERCLASS_IRIS] = TRAINER_MALE,
    [TRAINERCLASS_SAGE_RYOKU] = TRAINER_MALE,
    [TRAINERCLASS_SAGE_BRONIUS] = TRAINER_MALE,
    [TRAINERCLASS_MIASMA] = TRAINER_MALE,
    ...
    [TRAINERCLASS_CYNTHIA_PARTNER] = TRAINER_FEMALE,
