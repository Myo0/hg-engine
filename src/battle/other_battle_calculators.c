...
u8 LONG_CALL CalcSpeed(void *bw, struct BattleStruct *sp, int client1, int client2, int flag)
{
    ...
    if (ability2 == ABILITY_SLOW_START) {
        ...
        if (slowStartElapsed2 < 0) {
            slowStartModifier2 = UQ412__0_5;
        } else if (slowStartElapsed2 == 0) {
            slowStartModifier2 = UQ412__0_625;
        } else if (slowStartElapsed2 == 1) {
            slowStartModifier2 = UQ412__0_75;
        } else if (slowStartElapsed2 == 2) {
            slowStartModifier2 = UQ412__0_875;
        } else {
            slowStartModifier2 = 0;
        }
