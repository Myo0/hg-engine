...
BOOL btl_scr_cmd_FD_strengthsapcalc(void *bw, struct BattleStruct *sp);
...
const btl_scr_cmd_func NewBattleScriptCmdTable[] =
{
    ...
    [0xFD - START_OF_NEW_BTL_SCR_CMDS] = btl_scr_cmd_FD_strengthsapcalc,
};
 ...
 *  @return FALSE
 */
BOOL btl_scr_cmd_FD_strengthsapcalc(void *bw UNUSED, struct BattleStruct *sp) {
    IncrementBattleScriptPtr(sp, 1);
