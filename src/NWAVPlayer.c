...
void NWAVPlayer_play(int fileID)
{
    ...
    // NitroWAV-Tool writes loopStart/loopEnd as SAMPLE indices already, so no byte->sample
    // conversion here (dividing by bytesPerSample would halve them for PCM16 files).
