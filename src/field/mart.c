...
u16 sGoldenrodDepartment4F[] = {
    ITEM_FIRE_STONE, ITEM_WATER_STONE, ITEM_LEAF_STONE, ITEM_THUNDER_STONE,
    ITEM_SUN_STONE, ITEM_MOON_STONE, ITEM_ICE_STONE, ITEM_HONEY, ITEM_DRAGON_SCALE, 
    ITEM_TART_APPLE, ITEM_SWEET_APPLE, 0xFFFF
};
...
u16 sEcruteakMart[] = {
    ITEM_FIRE_STONE, ITEM_WATER_STONE, ITEM_LEAF_STONE, ITEM_THUNDER_STONE,
    ITEM_SUN_STONE, ITEM_MOON_STONE, ITEM_ICE_STONE, 0xFFFF
};
