...
const struct BadgeMartItems sBadgeMart[] = {
    ...
    { ITEM_AUSPICIOUS_ARMOR, 5 },
    { ITEM_MALICIOUS_ARMOR, 5 },
    { ITEM_CRACKED_POT, 4 },
    { ITEM_PEAT_BLOCK, 7 },
};
...
u16 sGoldenrodDepartment4F[] = {
    ITEM_RAZZ_BERRY, ITEM_BLUK_BERRY, ITEM_NANAB_BERRY, ITEM_WEPEAR_BERRY, ITEM_PINAP_BERRY, ITEM_POMEG_BERRY, ITEM_KELPSY_BERRY, ITEM_QUALOT_BERRY, ITEM_HONDEW_BERRY, ITEM_GREPA_BERRY, ITEM_TAMATO_BERRY, ITEM_CORNN_BERRY, ITEM_MAGOST_BERRY, ITEM_RABUTA_BERRY, ITEM_NOMEL_BERRY, ITEM_SPELON_BERRY, ITEM_PAMTRE_BERRY, ITEM_WATMEL_BERRY, ITEM_DURIN_BERRY, ITEM_BELUE_BERRY, ITEM_TM083, 0xFFFF
};

u16 sGoldenrodDepartment5F[] = {
    ITEM_TM028, ITEM_TM034, ITEM_TM040, ITEM_TM009, ITEM_TM175, ITEM_TM182, ITEM_TM217, ITEM_TM107, ITEM_TM073, 0xFFFF
};
...
u16 sOlivineMart[] = {
    ITEM_FIRE_STONE, ITEM_WATER_STONE, ITEM_LEAF_STONE, ITEM_THUNDER_STONE, ITEM_DAWN_STONE, ITEM_DUSK_STONE, ITEM_SUN_STONE, ITEM_MOON_STONE, ITEM_SHINY_STONE, ITEM_ICE_STONE, 0xFFFF
};
