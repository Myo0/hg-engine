...
// Electrum berry plants (see include/config.h BERRY_PLANT_TAG_START, and
// Docs&Changelog/Berry Plants.md for the full berry<->slot table).
//  tag     = DSPRE "Entry ID"  = BERRY_PLANT_TAG_START + berry type (0..57, = VAR_SPECIAL_x8009);
//            shared by every placed plant of that berry (the flag is a separate per-plant id)
//  gfx     = DSPRE "Sprite ID" = an unused follower slot (Unown OW B..! = 1782-1808,
//            Arceus/Silvally OW type-forms = 1824-1857) whose btx0 is swapped for the
//            berry-bush sprite by data/graphics/overworlds/follower_override/3_<gfx-297>.btx0
//  0x0020  = callback_params: unk4_5=1 -> SPRITE_TREE static behaviour, NO follower idle-hop
//            (the follower value 0x4E27 -> unk4_5=17 -> ov01_021F8D80/ov01_021F8FC0 add a
//            2px anim-synced Y hop; 0x0020's ov01_021F77A4 just draws the sprite in place).
#define BERRY_PLANT_ENTRY(tagn, gfxslot) \
    { .tag = BERRY_PLANT_TAG_START + (tagn), .gfx = (gfxslot), .callback_params = 0x0020 },
...
struct OVERWORLD_TAG gOWTagToFileNum[] = // skip down a bit to see the parts that are specifically for pokémon
    {
        ...
        // (Electrum) dropped: otherpoke's follower gfx slot for this form collides with
        // the existing berry-plant range (gfx 1782-1831); form is not obtainable by the
        // player in this fork, so this entry is safely omitted. See project_upstream_merge_140_plan.md.
        ...
        MON_FOLLOWER_ENTRY(SPECIES_UNOWN_B, OVERWORLD_SIZE_SMALL)
        MON_FOLLOWER_ENTRY(SPECIES_UNOWN_C, OVERWORLD_SIZE_SMALL)
        MON_FOLLOWER_ENTRY(SPECIES_UNOWN_D, OVERWORLD_SIZE_SMALL)
        MON_FOLLOWER_ENTRY(SPECIES_UNOWN_E, OVERWORLD_SIZE_SMALL)
        MON_FOLLOWER_ENTRY(SPECIES_UNOWN_F, OVERWORLD_SIZE_SMALL)
        MON_FOLLOWER_ENTRY(SPECIES_UNOWN_G, OVERWORLD_SIZE_SMALL)
        // (Electrum) dropped: otherpoke's follower gfx slot for this form collides with
        // the existing berry-plant range (gfx 1782-1831); form is not obtainable by the
        // player in this fork, so this entry is safely omitted. See project_upstream_merge_140_plan.md.
        ...
        MON_FOLLOWER_ENTRY(SPECIES_DEOXYS_ATTACK, OVERWORLD_SIZE_SMALL)
        MON_FOLLOWER_ENTRY(SPECIES_DEOXYS_DEFENSE, OVERWORLD_SIZE_SMALL)
        MON_FOLLOWER_ENTRY(SPECIES_DEOXYS_SPEED, OVERWORLD_SIZE_SMALL)
        ...
        // the existing berry-plant range (gfx 1782-1831); form is not obtainable by the
        // player in this fork, so this entry is safely omitted. See project_upstream_merge_140_plan.md.
        MON_FOLLOWER_ENTRY(SPECIES_ARCEUS_POISON, OVERWORLD_SIZE_LARGE)
        MON_FOLLOWER_ENTRY(SPECIES_ARCEUS_GROUND, OVERWORLD_SIZE_LARGE)
        MON_FOLLOWER_ENTRY(SPECIES_ARCEUS_ROCK, OVERWORLD_SIZE_LARGE)
        MON_FOLLOWER_ENTRY(SPECIES_ARCEUS_BUG, OVERWORLD_SIZE_LARGE)
        MON_FOLLOWER_ENTRY(SPECIES_ARCEUS_GHOST, OVERWORLD_SIZE_LARGE)
        MON_FOLLOWER_ENTRY(SPECIES_ARCEUS_STEEL, OVERWORLD_SIZE_LARGE)
        MON_FOLLOWER_ENTRY(SPECIES_ARCEUS_FAIRY, OVERWORLD_SIZE_LARGE)
        MON_FOLLOWER_ENTRY(SPECIES_ARCEUS_FIRE, OVERWORLD_SIZE_LARGE)
        MON_FOLLOWER_ENTRY(SPECIES_ARCEUS_WATER, OVERWORLD_SIZE_LARGE)
        MON_FOLLOWER_ENTRY(SPECIES_ARCEUS_GRASS, OVERWORLD_SIZE_LARGE)
        MON_FOLLOWER_ENTRY(SPECIES_ARCEUS_ELECTRIC, OVERWORLD_SIZE_LARGE)
        MON_FOLLOWER_ENTRY(SPECIES_ARCEUS_PSYCHIC, OVERWORLD_SIZE_LARGE)
        MON_FOLLOWER_ENTRY(SPECIES_ARCEUS_ICE, OVERWORLD_SIZE_LARGE)
        MON_FOLLOWER_ENTRY(SPECIES_ARCEUS_DRAGON, OVERWORLD_SIZE_LARGE)
        MON_FOLLOWER_ENTRY(SPECIES_ARCEUS_DARK, OVERWORLD_SIZE_LARGE)
        ...
        BERRY_PLANT_ENTRY( 0, 1782) // cheri
        BERRY_PLANT_ENTRY( 1, 1783) // chesto
        BERRY_PLANT_ENTRY( 2, 1784) // pecha
        BERRY_PLANT_ENTRY( 3, 1785) // rawst
        BERRY_PLANT_ENTRY( 4, 1786) // aspear
        BERRY_PLANT_ENTRY( 5, 1787) // leppa
        BERRY_PLANT_ENTRY( 6, 1788) // oran
        BERRY_PLANT_ENTRY( 7, 1789) // persim
        BERRY_PLANT_ENTRY( 8, 1790) // lum
        BERRY_PLANT_ENTRY( 9, 1791) // sitrus
        BERRY_PLANT_ENTRY(10, 1792) // figy
        BERRY_PLANT_ENTRY(11, 1793) // wiki
        BERRY_PLANT_ENTRY(12, 1794) // mago
        BERRY_PLANT_ENTRY(13, 1795) // aguav
        BERRY_PLANT_ENTRY(14, 1796) // iapapa
        BERRY_PLANT_ENTRY(15, 1797) // razz
        BERRY_PLANT_ENTRY(16, 1798) // bluk
        BERRY_PLANT_ENTRY(17, 1799) // nanab
        BERRY_PLANT_ENTRY(18, 1800) // wepear
        BERRY_PLANT_ENTRY(19, 1801) // pinap
        BERRY_PLANT_ENTRY(20, 1802) // cornn
        BERRY_PLANT_ENTRY(21, 1803) // magost
        BERRY_PLANT_ENTRY(22, 1804) // rabuta
        BERRY_PLANT_ENTRY(23, 1805) // nomel
        BERRY_PLANT_ENTRY(24, 1806) // spelon
        BERRY_PLANT_ENTRY(25, 1807) // pamtre
        BERRY_PLANT_ENTRY(26, 1808) // watmel
        BERRY_PLANT_ENTRY(27, 1824) // durin
        BERRY_PLANT_ENTRY(28, 1825) // belue
        BERRY_PLANT_ENTRY(29, 1826) // occa
        BERRY_PLANT_ENTRY(30, 1827) // passho
        BERRY_PLANT_ENTRY(31, 1828) // wacan
        BERRY_PLANT_ENTRY(32, 1829) // rindo
        BERRY_PLANT_ENTRY(33, 1830) // yache
        BERRY_PLANT_ENTRY(34, 1831) // chople
        BERRY_PLANT_ENTRY(35, 1832) // kebia
        BERRY_PLANT_ENTRY(36, 1833) // shuca
        BERRY_PLANT_ENTRY(37, 1834) // coba
        BERRY_PLANT_ENTRY(38, 1835) // payapa
        BERRY_PLANT_ENTRY(39, 1836) // tanga
        BERRY_PLANT_ENTRY(40, 1837) // charti
        BERRY_PLANT_ENTRY(41, 1838) // kasib
        BERRY_PLANT_ENTRY(42, 1839) // haban
        BERRY_PLANT_ENTRY(43, 1840) // colbur
        BERRY_PLANT_ENTRY(44, 1841) // babiri
        BERRY_PLANT_ENTRY(45, 1842) // chilan
        BERRY_PLANT_ENTRY(46, 1843) // liechi
        BERRY_PLANT_ENTRY(47, 1844) // ganlon
        BERRY_PLANT_ENTRY(48, 1845) // salac
        BERRY_PLANT_ENTRY(49, 1846) // petaya
        BERRY_PLANT_ENTRY(50, 1847) // apicot
        BERRY_PLANT_ENTRY(51, 1848) // lansat
        BERRY_PLANT_ENTRY(52, 1849) // starf
        BERRY_PLANT_ENTRY(53, 1850) // enigma
        BERRY_PLANT_ENTRY(54, 1851) // micle
        BERRY_PLANT_ENTRY(55, 1852) // custap
        BERRY_PLANT_ENTRY(56, 1853) // jaboca
        BERRY_PLANT_ENTRY(57, 1854) // rowap

        // Mega Stone overworld pickups -- cosmetic-only static field items (see
        // Docs&Changelog/Mega Stones.md). Unlike the berries above, these are genuine,
        // previously-unclaimed MON_FOLLOWER_ENTRY slots (no existing entry to work around),
        // so no synthetic tag range is needed -- Entry ID is just the ordinary
        // MON_OVERWORLD_TAG_START + species value the macro always computes.
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_VENUSAUR, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_CHARIZARD_X, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_CHARIZARD_Y, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_BLASTOISE, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_BEEDRILL, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_PIDGEOT, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_ALAKAZAM, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_SLOWBRO, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_GENGAR, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_KANGASKHAN, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_PINSIR, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_GYARADOS, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_AERODACTYL, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_MEWTWO_X, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_MEWTWO_Y, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_AMPHAROS, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_STEELIX, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_SCIZOR, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_HERACROSS, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_HOUNDOOM, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_TYRANITAR, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_SCEPTILE, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_BLAZIKEN, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_SWAMPERT, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_GARDEVOIR, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_SABLEYE, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_MAWILE, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_AGGRON, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_MEDICHAM, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_MANECTRIC, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_SHARPEDO, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_CAMERUPT, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_ALTARIA, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_BANETTE, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_ABSOL, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_GLALIE, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_SALAMENCE, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_METAGROSS, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_LATIAS, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_LATIOS, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_LOPUNNY, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_GARCHOMP, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_LUCARIO, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_ABOMASNOW, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_GALLADE, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_AUDINO, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_DIANCIE, 0x0020)
        // SPECIES_MEGA_RAYQUAZA intentionally omitted -- no source art yet (see Mega Stones.md)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_RAICHU_X, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_RAICHU_Y, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_CLEFABLE, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_VICTREEBEL, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_STARMIE, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_DRAGONITE, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_MEGANIUM, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_FERALIGATR, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_SKARMORY, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_CHIMECHO, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_ABSOL_Z, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_STARAPTOR, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_GARCHOMP_Z, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_LUCARIO_Z, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_FROSLASS, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_HEATRAN, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_DARKRAI, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_EMBOAR, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_EXCADRILL, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_SCOLIPEDE, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_SCRAFTY, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_EELEKTROSS, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_CHANDELURE, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_GOLURK, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_CHESNAUGHT, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_DELPHOX, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_GRENINJA, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_PYROAR, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_FLOETTE, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_MEOWSTIC, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_MALAMAR, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_BARBARACLE, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_DRAGALGE, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_HAWLUCHA, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_ZYGARDE, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_CRABOMINABLE, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_GOLISOPOD, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_DRAMPA, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_MAGEARNA, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_ZERAORA, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_FALINKS, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_SCOVILLAIN, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_GLIMMORA, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_TATSUGIRI, 0x0020)
        MON_FOLLOWER_ENTRY(SPECIES_MEGA_BAXCALIBUR, 0x0020)
