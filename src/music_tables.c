...
u16 MainMusicComboTable[][2] =
{
    ...
    [ANIM_MUSIC_COMBO_DARKRAI] = {0x1B, SEQ_PRIMAL_DIALGA_BATTLE},
    ...
    [ANIM_MUSIC_COMBO_WILL] = {0x1D,  SEQ_G5_ELITE_4}, //was 0x1D
    [ANIM_MUSIC_COMBO_KOGA] = {0x1E,  SEQ_G5_ELITE_4},
    [ANIM_MUSIC_COMBO_BRUNO] = {0x1F,  SEQ_G5_ELITE_4},
    [ANIM_MUSIC_COMBO_KAREN] = {0x20,  SEQ_G5_ELITE_4},
    ...
    [ANIM_MUSIC_COMBO_DUSKNOIR] = {0xFFFF, SEQ_PRIMAL_DIALGA_BATTLE},
    [ANIM_MUSIC_COMBO_LANCE] = {0x21, SEQ_G5_ELITE_4},
    ...
    [ANIM_MUSIC_COMBO_RED] = {0x2E, SEQ_PRIMAL_DIALGA_BATTLE},
...
u8 TrainerClassToMusicCombo[][2] =
{
    ...
    {TRAINERCLASS_DUSKNOIR, ANIM_MUSIC_COMBO_DUSKNOIR*4},
