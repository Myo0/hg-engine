...
u16 MainMusicComboTable[][2] =
{
    ...
    [ANIM_MUSIC_COMBO_BUGSY] = {0xD, SEQ_SINNOH_LEADER},
    [ANIM_MUSIC_COMBO_WHITNEY] = {0xE, SEQ_SINNOH_LEADER},
    [ANIM_MUSIC_COMBO_MORTY] = {0xF, SEQ_SINNOH_LEADER},
    [ANIM_MUSIC_COMBO_JASMINE] = {0x10, SEQ_SINNOH_LEADER},
    [ANIM_MUSIC_COMBO_CHUCK] = {0x11, SEQ_SINNOH_LEADER},
    [ANIM_MUSIC_COMBO_PRYCE] = {0x12, SEQ_SINNOH_LEADER},
    [ANIM_MUSIC_COMBO_CLAIR] = {0x13, SEQ_SINNOH_LEADER},
    ...
    [ANIM_MUSIC_COMBO_ZINZOLIN] = {0x21, SEQ_VS_N_1},
    ...
    [ANIM_MUSIC_COMBO_GALACTIC] = {0x27, SEQ_GS_VS_ROCKET},
    [ANIM_MUSIC_COMBO_JUPITER] = {0x28, SEQ_CYRUS_COMPLETE},
...
u8 TrainerClassToMusicCombo[][2] =
{
    ...
    {TRAINERCLASS_LT_SURGE, ANIM_MUSIC_COMBO_MIASMA*4},
    {TRAINERCLASS_MIASMA, ANIM_MUSIC_COMBO_MIASMA*4},
    {TRAINERCLASS_JUPITER, ANIM_MUSIC_COMBO_JUPITER*4},
    ...
    {TRAINERCLASS_GALACTIC_M, ANIM_MUSIC_COMBO_GALACTIC*4},
    {TRAINERCLASS_GALACTIC_F, ANIM_MUSIC_COMBO_GALACTIC*4},
...
struct TrainerMusic sTrainerEncounterMusicParam[] = // cues which music sequence occurs upon eyes meeting
{
    ...
    {.class = TRAINERCLASS_JUPITER, .music1 = SEQ_GS_EYE_ROCKET, .music2 = SEQ_GS_EYE_ROCKET},
    {.class = TRAINERCLASS_CYRUS, .music1 = SEQ_GS_EYE_ROCKET, .music2 = SEQ_GS_EYE_ROCKET},
    ...
    {.class = TRAINERCLASS_PLASMA_M, .music1 = SEQ_VS_PLASMA_LEAD_UP, .music2 = SEQ_VS_PLASMA_LEAD_UP},
};
