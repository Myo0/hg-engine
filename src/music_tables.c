...
u16 MainMusicComboTable[][2] =
{
    ...
    [ANIM_MUSIC_COMBO_FRONTIER_BRAIN] = {0x22, SEQ_GS_BA_BRAIN}, // custom
...
u8 TrainerClassToMusicCombo[][2] =
{
    ...
    // (***END OF VANILLA ENTRIES***)
    {TRAINERCLASS_TOWER_TYCOON, ANIM_MUSIC_COMBO_FRONTIER_BRAIN*4}, // custom
    {TRAINERCLASS_HALL_MATRON, ANIM_MUSIC_COMBO_FRONTIER_BRAIN*4}, // custom
    {TRAINERCLASS_ARCADE_STAR, ANIM_MUSIC_COMBO_FRONTIER_BRAIN*4}, // custom
    {TRAINERCLASS_CASTLE_VALET, ANIM_MUSIC_COMBO_FRONTIER_BRAIN*4}, // custom
    {TRAINERCLASS_FACTORY_HEAD, ANIM_MUSIC_COMBO_FRONTIER_BRAIN*4}, // custom
};
...
struct MonBattleMusic PokemonBattleMusic[] =
{
    ...
    // {.species = SPECIES_TORNADUS,  .combo = ANIM_MUSIC_COMBO_MEWTWO_LATI_TWINS},
    // {.species = SPECIES_CRESSELIA, .combo = ANIM_MUSIC_COMBO_MEWTWO_LATI_TWINS},
    // {.species = SPECIES_THUNDURUS, .combo = ANIM_MUSIC_COMBO_MEWTWO_LATI_TWINS},
    // {.species = SPECIES_REGIELEKI, .combo = ANIM_MUSIC_COMBO_MEWTWO_LATI_TWINS},
    // {.species = SPECIES_LANDORUS,  .combo = ANIM_MUSIC_COMBO_MEWTWO_LATI_TWINS},
    // (***END VANILLA ENTRIES***)
};
...
struct TrainerMusic sTrainerEncounterMusicParam[] = // cues which music sequence occurs upon eyes meeting
{
    ...
    {.class = TRAINERCLASS_FACTORY_HEAD, .music1 = SEQ_GS_EYE_J_AYASHII, .music2 = SEQ_GS_EYE_J_AYASHII},
};
