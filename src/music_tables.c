...
{
    [ANIM_MUSIC_COMBO_FALKNER] = {0xC, SEQ_SINNOH_LEADER},
    ...
    [ANIM_MUSIC_COMBO_IRIS] = {0x1C, SEQ_RIVAL_BATTLE_BW},
...
u8 TrainerClassToMusicCombo[][2] =
{
    ...
    {TRAINERCLASS_MARLON, ANIM_MUSIC_COMBO_MARLON*4},
    ...
    {TRAINERCLASS_IRIS, ANIM_MUSIC_COMBO_IRIS*4},
    {TRAINERCLASS_CYRUS, ANIM_MUSIC_COMBO_CYRUS*4},
