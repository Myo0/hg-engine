...
u16 MainMusicComboTable[][2] = {
    ...
    // custom: the four Team Rocket Executives get a custom theme.
    [ANIM_MUSIC_COMBO_PETREL] = { 0x28, 9002 },
    [ANIM_MUSIC_COMBO_PROTON] = { 0x29, 9002 },
    [ANIM_MUSIC_COMBO_ARCHER] = { 0x2A, 9002 },
    [ANIM_MUSIC_COMBO_ARIANA] = { 0x2B, 9002 },
...
struct TrainerMusic sTrainerEncounterMusicParam[] = // cues which music sequence occurs upon eyes meeting
    {
        ...
        { .class = TRAINERCLASS_SOCIALITE, .music1 = SEQ_GS_EYE_J_SHOUJO, .music2 = SEQ_GS_EYE_J_SHOUJO },
    };
