...
{
    { .class = TRAINERCLASS_JASPER, .multiplier = 0 },
    { .class = TRAINERCLASS_AMETHYST, .multiplier = 0 },
    ...
    { .class = TRAINERCLASS_SHADOW_TRIAD, .multiplier = 2 },
    ...
    { .class = TRAINERCLASS_PLASMA_M, .multiplier = 1 },
    { .class = TRAINERCLASS_PLASMA_F, .multiplier = 1 },
    { .class = TRAINERCLASS_SAILOR, .multiplier = 8 },
    { .class = TRAINERCLASS_TRAINER_N, .multiplier = 30 },
    ...
    { .class = TRAINERCLASS_SAGE_ROOD, .multiplier = 30 },
    ...
    { .class = TRAINERCLASS_GALACTIC_M, .multiplier = 10 },
    { .class = TRAINERCLASS_SKIER, .multiplier = 8 },
    { .class = TRAINERCLASS_ROUGHNECK, .multiplier = 6 },
    { .class = TRAINERCLASS_SAGE_GORM, .multiplier = 6 },
    ...
    { .class = TRAINERCLASS_GALACTIC_F, .multiplier = 10 },
    { .class = TRAINERCLASS_BURGLAR, .multiplier = 4 },
    { .class = TRAINERCLASS_FIREBREATHER, .multiplier = 8 },
    { .class = TRAINERCLASS_BIKER, .multiplier = 4 },
    { .class = TRAINERCLASS_VOLKNER, .multiplier = 30 },
    { .class = TRAINERCLASS_FLINT, .multiplier = 30 },
    ...
    { .class = TRAINERCLASS_SAGE_GIALLO, .multiplier = 8 },
    { .class = TRAINERCLASS_WAITER, .multiplier = 8 },
    { .class = TRAINERCLASS_STEVEN, .multiplier = 50 },
    { .class = TRAINERCLASS_CAMERAMAN, .multiplier = 8 },
    { .class = TRAINERCLASS_REPORTER, .multiplier = 10 },
    { .class = TRAINERCLASS_COLRESS, .multiplier = 18 },
    ...
    { .class = TRAINERCLASS_DARKRAI, .multiplier = 0 },
    { .class = TRAINERCLASS_MISTY, .multiplier = 30 },
    { .class = TRAINERCLASS_ZINZOLIN, .multiplier = 0 },
    { .class = TRAINERCLASS_GHETSIS, .multiplier = 0 },
    { .class = TRAINERCLASS_GARDENIA, .multiplier = 0 },
    { .class = TRAINERCLASS_ROXIE, .multiplier = 0 },
    { .class = TRAINERCLASS_LT_SURGE, .multiplier = 30 },
    { .class = TRAINERCLASS_ERIKA, .multiplier = 30 },
    { .class = TRAINERCLASS_DUSKNOIR, .multiplier = 30 },
    { .class = TRAINERCLASS_CYNTHIA_OPPONENT, .multiplier = 30 },
    { .class = TRAINERCLASS_HANNAH, .multiplier = 30 },
    ...
    { .class = TRAINERCLASS_JUPITER, .multiplier = 20 },
    { .class = TRAINERCLASS_BOARDER, .multiplier = 8 },
    { .class = TRAINERCLASS_CYRUS, .multiplier = 20 },
    { .class = TRAINERCLASS_SATURN, .multiplier = 10 },
    { .class = TRAINERCLASS_MARS, .multiplier = 10 },
    { .class = TRAINERCLASS_IRIS, .multiplier = 25 },
    { .class = TRAINERCLASS_SAGE_RYOKU, .multiplier = 30 },
    { .class = TRAINERCLASS_SAGE_BRONIUS, .multiplier = 30 },
    { .class = TRAINERCLASS_MIASMA, .multiplier = 16 },
    ...
    { .class = TRAINERCLASS_CYNTHIA_PARTNER, .multiplier = 0 },
