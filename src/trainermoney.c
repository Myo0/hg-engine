...
struct TrainerMoney PrizeMoney[] = // 0x34C04 in Overlay 12; 2 bytes for trainer class ID, 2 bytes for modifier; 516 bytes in total in vanilla
{
    ...
    { .class = TRAINERCLASS_MARLON, .multiplier = 30 },
    ...
    { .class = TRAINERCLASS_TATE_AND_LIZA, .multiplier = 30 },
    { .class = TRAINERCLASS_BROKEN, .multiplier = 30 },
    { .class = TRAINERCLASS_WINONA, .multiplier = 30 },
