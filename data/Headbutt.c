...
const HeadbuttArchiveData __data =
{
    ...
    .ilexForest = {
        ...
        .normalSlots =
        {
            { SPECIES_SURSKIT, 15, 15 },
            { SPECIES_VENIPEDE, 15, 15 },
            { SPECIES_CARNIVINE, 15, 15 },
            { SPECIES_HERACROSS, 15, 15 },
            { SPECIES_WIMPOD, 15, 15 },
            { SPECIES_WIMPOD, 15, 15 },
            { SPECIES_SURSKIT, 15, 15 },
            { SPECIES_VENIPEDE, 15, 15 },
            { SPECIES_CARNIVINE, 15, 15 },
